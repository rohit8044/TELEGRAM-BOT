        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a id="bt4" href="reseller/index.php" class="menu-link">
                    <div>Dashboard</div>
                  </a>
                </li>
              </ul>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="reseller/add-user.php" class="menu-link">
                    <div>Add User</div>
                  </a>
                </li>
                ...
                <li class="menu-item">
                  <a id="bt4" href="reseller/manage-users.php" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="reseller/download-apk.php" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="reseller/download-script.php" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="reseller/download-lib.php" class="menu-link">
	...
	echo $count; ?></span>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                      <a id="bt4" class="dropdown-item" href="reseller/profile.php">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                              <img src="./assets/img/avatars/bt4.png" alt class="h-auto rounded-circle" />
