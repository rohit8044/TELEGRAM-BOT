        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a id="bt4" href="owner/index.php" class="menu-link">
                    <div>Dashboard</div>
                  </a>
                </li>
              </ul>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="owner/add-user.php" class="menu-link">
                    <div>Add User</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/add-days.php" class="menu-link">
                    <div>Add Days</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-users.php" class="menu-link">
                    <div>Manage Users</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-ud-users.php" class="menu-link">
                    <div>Manage UD Users</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-reg-users.php" class="menu-link">
                    <div>Manage Reg Users</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-apk-users.php" class="menu-link">
                    <div>Manage Apk Users</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a id="bt4" href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div>Reseller Management</div>
              </a>
              <ul class="menu-sub">
              
                <li class="menu-item">
                  <a id="bt4" href="owner/add-reseller.php" class="menu-link">
                    <div>Add Reseller</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/add-credits.php" class="menu-link">
                    <div>Add Credits</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-reseller.php" class="menu-link">
                    <div>Manage Resellers</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="owner/add-admin.php" class="menu-link">
                    <div>Add Admin</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-admin.php" class="menu-link">
            ...
            <li class="menu-item">
              <a id="bt4" href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons ti ti-bell ti-md"></i>
                <div>Notif Management</div>
              </a>
              <ul class="menu-sub">
              
                <li class="menu-item">
                  <a id="bt4" href="owner/add-notif.php" class="menu-link">
                    <div>Add Notif</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-notif.php" class="menu-link">
                    <div>Manage Notif</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="owner/add-apk.php" class="menu-link">
                    <div>Add Apk</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-apk.php" class="menu-link">
                    <div>Manage Apk</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="owner/add-script.php" class="menu-link">
                    <div>Add Script</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-script.php" class="menu-link">
                    <div>Manage Script</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="owner/add-lib.php" class="menu-link">
                    <div>Add Lib</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-lib.php" class="menu-link">
                    <div>Manage Lib</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="owner/mod-name.php" class="menu-link">
                    <div>Mod Name</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/safe-or-not.php" class="menu-link">
                    <div>Mod Safe or Not</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/mod-status.php" class="menu-link">
                    <div>Mod Status</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/mod-function.php" class="menu-link">
                    <div>Mod Functions</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/update-mod.php" class="menu-link">
                    <div>Update Mod</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/lib-online.php" class="menu-link">
                    <div>Lib Online</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="owner/add-product.php" class="menu-link">
                    <div>Add Product</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-product.php" class="menu-link">
                    <div>Manage Products</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/manage-orders.php" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a id="bt4" href="owner/server-name.php" class="menu-link">
                    <div>Server Name</div>
                  </a>
                </li>
                
                <li class="menu-item">
                  <a id="bt4" href="owner/server-status.php" class="menu-link">
	...
	echo $count; ?></span>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                      <a id="bt4" class="dropdown-item" href="owner/profile.php">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                              <img src="./assets/img/avatars/bt4.png" alt class="h-auto rounded-circle" />
